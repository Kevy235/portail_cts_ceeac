export const fr = {
  ...
  "dash.addAdmin": "Ajouter un administrateur",
  ...
  "activity.admin_created": "Nouvel administrateur",
  "activity.admin_updated": "Administrateur mis à jour",
  "activity.admin_deleted": "Administrateur supprimé",
  ...
  "adm.title": "Administrateurs du portail",
  "adm.subtitle": "Comptes habilités à gérer les réunions, documents et participants",
  "adm.create": "Nouvel administrateur",
  "adm.searchPh": "Rechercher par nom ou e-mail…",
  "adm.colName": "Administrateur",
  "adm.colFunction": "Fonction",
  "adm.colStatus": "Statut",
  "adm.colLastLogin": "Dernière connexion",
  "adm.colActions": "Actions",
  "adm.shown": "{n} administrateur(s) affiché(s)",
  "adm.emptySearch": "Aucun administrateur ne correspond à la recherche",
  "adm.empty": "Aucun administrateur",
  "adm.you": "Vous",
  "adm.createTitle": "Créer un administrateur",
  "adm.createSubtitle": "Un mot de passe provisoire sera généré et affiché une seule fois",
  "adm.editTitle": "Modifier l'administrateur",
  "adm.fullName": "Nom complet",
  "adm.fullNamePh": "Prénom Nom",
  "adm.email": "Adresse e-mail",
  "adm.emailPh": "prenom.nom@ceeac-eccas.org",
  "adm.function": "Fonction",
  "adm.functionPh": "Secrétariat",
  "adm.institution": "Service / institution",
  "adm.institutionPh": "Secrétariat général de la CEEAC",
  "adm.status": "Statut",
  "adm.statusSelfHint": "Vous ne pouvez pas désactiver votre propre compte.",
  "adm.createBtn": "Créer le compte",
  "adm.created": "Administrateur créé",
  "adm.updated": "Administrateur mis à jour",
  "adm.deleted": "{name} supprimé",
  "adm.deleteTitle": "Supprimer l'administrateur",
  "adm.deleteMsg":
    "Le compte de {name} ({email}) sera définitivement supprimé. Cette action est irréversible.",
  "adm.deleteSelf": "Vous ne pouvez pas supprimer votre propre compte",
  "adm.lastAdmin": "Impossible de supprimer le dernier administrateur actif",
  "adm.resetPwd": "Réinitialiser le mot de passe",
  "adm.resetSelf": "Réinitialisez votre mot de passe depuis votre compte",
  "adm.resetTitle": "Réinitialiser le mot de passe",
  "adm.resetMsg":
    "Un mot de passe provisoire sera généré pour {name}. Ses sessions ouvertes seront révoquées.",
  "adm.pwdReset": "Mot de passe réinitialisé",
  "adm.tempNote":
    "L'administrateur devra définir un nouveau mot de passe lors de sa première connexion.",
  "adm.opFailed": "Opération impossible",
