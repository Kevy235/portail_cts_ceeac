...
const ACTIVITY_ICONS: Record<string, { icon: React.ReactNode; bg: string }> = {
  ...
  admin_created: { icon: <Shield size={14} className="text-brand" />, bg: "bg-brand-soft" },
  admin_updated: { icon: <Shield size={14} className="text-brand" />, bg: "bg-brand-soft" },
  admin_deleted: { icon: <Trash2 size={14} className="text-danger" />, bg: "bg-danger-soft" },
...
const ACTIVITY_KEYS: Record<string, keyof Dict> = {
  ...
  admin_created: "activity.admin_created",
  admin_updated: "activity.admin_updated",
  admin_deleted: "activity.admin_deleted",
          ...
          <div className="bg-white rounded-xl border border-line-soft p-4">
            ...
            <div className="space-y-2">
              {[
                ...
                { label: t("dash.addAdmin"), to: "/admin/administrateurs", icon: <Shield size={13} /> },
